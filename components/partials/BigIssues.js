...
export default () => (
  <Section>
    ...
    <ol>
      <li>
        <Card
          title="Fighting climate change and blocking oil and gas drilling"
      ...
      <li>
        <Card
          title="Protecting the bees and our food supplies"
      ...
      <li>
        <Card
          title="Challenging businesses backing the far right"
